...
public class CardDeclaration : ASTnode
{
    ...
    public CardDeclaration(ASTnode type, ASTnode name, ASTnode faction, ASTnode power, List<ASTnode> range, List<ASTnode> effects)
    {
        Type = type;
        Name = name;
        Faction = faction;
